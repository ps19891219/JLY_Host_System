(function () {
  ...
  async function mount() {
    ...
    try {
      ...
      const menuButton=section.querySelector("#accountingMenuButton"),menuPanel=section.querySelector("#accountingMenuPanel"),manageToggle=section.querySelector("#accountingManageToggle"),viewPerson=section.querySelector("#accountingViewPerson");
      if(menuButton&&menuPanel)menuButton.addEventListener("click",()=>menuPanel.hidden=!menuPanel.hidden);
