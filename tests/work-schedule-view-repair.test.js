...
assert(page.includes('inputmode="text"'),'date search should allow slash input on iPhone');
assert(page.includes('class="schedule-results-head" hidden'),'obsolete schedule title must stay hidden');
