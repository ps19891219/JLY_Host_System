...
const base={date:'2026-10-01',startTime:'19:00',endTime:'23:00',studioName:'A',assignedPersonIds:['p1','p2'],staffSlots:[{id:'s1',label:'1',personId:'p1'}]};
...
next={...base,staffSlots:[{id:'s1',label:'A位',personId:'p1'}]};assert.equal(P.classify(base,next).calendarForbidden,true);plan=P.calendarPlan(base,next);assert.equal(plan.create.length+plan.update.length+plan.remove.length,0);
